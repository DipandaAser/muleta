...
[![@muleta-dev/server on npm](https://img.shields.io/npm/v/@muleta-dev/server?label=%40muleta-dev%2Fserver&logo=npm)](https://www.npmjs.com/package/@muleta-dev/server) [![@muleta-dev/core on npm](https://img.shields.io/npm/v/@muleta-dev/core?label=%40muleta-dev%2Fcore&logo=npm)](https://www.npmjs.com/package/@muleta-dev/core) [![npm downloads (server)](https://img.shields.io/npm/dm/@muleta-dev/server?label=downloads&logo=npm)](https://www.npmjs.com/package/@muleta-dev/server) [![Docker / GHCR](https://img.shields.io/github/v/tag/DipandaAser/muleta?filter=v*&label=docker%20%2F%20ghcr&logo=docker&color=2496ed)](https://github.com/orgs/muleta-dev/packages/container/package/muleta) [![CI](https://img.shields.io/github/actions/workflow/status/DipandaAser/muleta/ci.yml?branch=main&label=ci&logo=github)](https://github.com/DipandaAser/muleta/actions/workflows/ci.yml) [![License](https://img.shields.io/github/license/DipandaAser/muleta?color=blue)](LICENSE) <a href="https://www.producthunt.com/products/muleta?embed=true&amp;utm_source=badge-featured&amp;utm_medium=badge&amp;utm_campaign=badge-muleta" target="_blank" rel="noopener noreferrer"><img alt="Muleta - Open-source dashboard 4 BullMQ | Product Hunt" width="100" height="19" src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=1145369&amp;theme=light&amp;t=1778598286640"></a>
